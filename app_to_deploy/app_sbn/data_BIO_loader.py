...
def convert_examples_to_features(args, train_instances, max_span_length=8):
    ...
    for ex_index, example in enumerate(train_instances):
        ...
        for triple_name in sample['triples']:
            ...
            if int(sample['triples'][triple_name][0][1]) - int(sample['triples'][triple_name][0][0]) < max_span_length \
                and int(sample['triples'][triple_name][1][1]) - int(sample['triples'][triple_name][1][0]) < max_span_length: 
                num_triple += 1
