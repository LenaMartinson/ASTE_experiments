...
class MyDataset:
    def __init__(self, args, path, if_train=False):
        ...
        with open(path, 'r', encoding='utf-8') as f:
            ...
            # data_instances, aspect_num, num_opinion = convert_examples_to_features(args, train_instances=self.instances,
    ...
    def __getitem__(self, idx):
        data_instances, _, _ = convert_examples_to_features(self.args, train_instances=[self.instances[idx]],
...
class DataTterator(object):
    ...
    def get_instances(self, batch_num):
        ...
        instances = [self.dataset.__getitem__(i)[0] for i in range(bb, min(bb + self.batch_size, len(self.dataset)))]
        return instances
