...
class Dim_Four_Attention(nn.Module):
    def __init__(self, hidden_size, num_attention_heads, attention_probs_dropout_prob, layer_norm_eps, hidden_dropout_prob):
        super().__init__()
        self.output = SelfOutput(hidden_size, layer_norm_eps, hidden_dropout_prob)
...
class Attention(nn.Module):
    def __init__(self, hidden_size, layer_norm_eps, hidden_dropout_prob,num_attention_heads, attention_probs_dropout_prob):
        super().__init__()
...
class Output(nn.Module):
    def __init__(self, hidden_size, layer_norm_eps, hidden_dropout_prob, intermediate_size):
        super().__init__()
